            ...
            <div class="main-container">
                <div class="auth-container">
                    <div class="auth-header">
                        ...
                        <p>Compila il form con i tuoi dati per registrarti al servizio. Potrai utilizzare l'account quando l'admin avrà verificato e accettato il tuo account</p>
                    </div>
                    ...
                    <form id="register-form" class="auth-form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="email" name="email" placeholder="nome.cognome@itisavogadro.it" required onkeyup="checkExists(this.value)">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="codFis" name="codFis" placeholder="Il tuo codice fiscale" required>
                            </div>
